...
(function () {
    ...
    function getPlayerInfo() {
        if (sessionStorage.lbastAuto_playerNickname && sessionStorage.lbastAuto_playerAlignment && sessionStorage.lbastAuto_playerHasSkill) {
            return {
        ...
        sessionStorage.lbastAuto_playerHasSkill = ~xhr.responseText.indexOf('Боевое умение') ? 'true' : 'false';
